...
import com.exemple.TheMovieDB.model.response.home.upcoming.Result

class UpcomingMovieViewHolder(val binding: AllMoviesItemBinding):RecyclerView.ViewHolder(binding.root) {
